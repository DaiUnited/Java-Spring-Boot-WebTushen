                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mx-auto">
                                            <div class="d-flex justify-content-between">
                                                <h3>Product Table</h3>
                                                <a href="<c:url value='/admin/product/create'/>" class="btn btn-primary">Create New Product</a>
                                            </div>
                                            <hr>
                                                    ...
                                                    <tr id="productRow-${product.productId}">
                                                        ...
                                                        <td>
                                                            <c:if test="${not empty product.image}">
                                                                <img src="<c:url value='/template/admin/product/image/${product.image}'/>" alt="${product.image}" style="width:100px;height:100px;object-fit:cover;">

                                                            </c:if>
                                                        </td>
                                                        <td>${product.category.categoryName}</td>
                                                        <td>
                                                            <a class="btn btn-success" href="<c:url value='/admin/product/view/${product.productId}'/>">View</a>
                                                            <a class="btn btn-warning" href="<c:url value='/admin/product/update/${product.productId}'/>">Update</a>
                                                            <a class="btn btn-danger" href="<c:url value='/admin/product/delete/${product.productId}'/>"
